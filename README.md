...
| [Foundry GPT-Live conversation](foundry-gpt-live/) | Full-duplex voice conversation with live transcripts, interruption support, and a five-minute session limit. | [Live demo](https://foundry-gpt-live-demo.wonderfulforest-c2bd4c50.swedencentral.azurecontainerapps.io) · [Frontend source](foundry-gpt-live/static/) | [Run locally](foundry-gpt-live/README.md#run-locally) · [Deploy to Azure](foundry-gpt-live/README.md#deploy-to-azure) |
